...
public class InfrastructureConfig {
    ...
    @Bean
    public FinishOrderUseCase finishOrderUseCase(OrderRepository orderRepository, PaymentGateway paymentGateway) {
        return new FinishOrderUseCase(orderRepository, paymentGateway);
    }
